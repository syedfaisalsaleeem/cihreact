...
export default function ECContent(){
        ...
        <Grid container>
            <Grid item xs={6}>
                <Grid container spacing={2}>
                    ...
                    <Grid item>
                    <LightTooltip title="Exposed usernames and passwords which can be used to access your internal systems, or access third-party systems such as supply chain or social media platforms.">
                    <InfoOutlinedIcon />
                    </LightTooltip >
                    </Grid>
                </Grid>
