...
const initialState = {
  ...
  socialsecuritynumber: {
    ...
    value: {
      spainsocialsecuritynumbers: false,
      latviasocialsecuritynumbers: false,
      lithuaniasocialsecuritynumbers: false,
      malaysiasocialsecuritynumbers: false,
      indonesiasocialsecuritynumbers: false,
      Hongkongsocialsecuritynumbers: false,
      arabemiratessocialsecuritynumbers: false,
      southafricasocialsecuritynumbers: false,
      chinasocialsecuritynumbers: false,
      belgiumsocialsecuritynumbers: false,
      bulgariasocialsecuritynumbers: false,
      croatiasocialsecuritynumbers: false,
      czechrepublicsocialsecuritynumbers: false,
      denmarksocialsecuritynumbers: false,
      francesocialsecuritynumbers: false,
      greecesocialsecuritynumbers: false,
      irelandsocialsecuritynumbers: false,
      estoniasocialsecuritynumbers: false,
      italysocialsecuritynumbers: false,
      netherlandssocialsecuritynumbers: false,
      norwaysocialsecuritynumbers: false,
      polandsocialsecuritynumbers: false,
      romaniasocialsecuritynumbers: false,
      swedensocialsecuritynumbers: false,
      sloveniasocialsecuritynumbers: false,
      slovakiasocialsecuritynumbers: false,
      singaporesocialsecuritynumbers: false,
      finlandsocialsecuritynumbers: false,
  ...
  switch (action.type) {
    ...
    case "medium":
      ...
      if (action.payload === true) {
        ...
        return {
          ...state,
          query: [...state.query, "severitymedium"],
          severitylevel: { ...state.severitylevel, medium: !action.payload },
        };
      }
    case "high":
      ...
      if (action.payload === true) {
        ...
        return {
          ...state,
          query: [...state.query, "severityhigh"],
          severitylevel: { ...state.severitylevel, high: !action.payload },
        };
      }
    case "deepweb":
    ...
    case "socialsecuritynumber":
      return {
        ...
        socialsecuritynumber: {
          ...
          control: {
            ...state.socialsecuritynumber.control,
        ...
        return {
          ...
          socialsecuritynumber: {
            ...
            value: {
              ...
              [action.payload.value2]: !action.payload.value1,
            },
          },
        };
      } else {
    ...
    case "otherin":
      ...
      if (action.payload.value1 === true) {
        const listi = Object.assign([], state.query);
        for (var i = 0; i < listi.length; i++) {
          if (listi[i] === action.payload.value2) {
            listi.splice(i, 1);
          }
        }
        ...
        return {
          ...state,
          query: [...state.query, action.payload.value2],
          other: {
            ...state.other,
            value: {
              ...state.other.value,
    ...
    case "sensitiveinformation":
      if (action.payload === true) {
        const listi = Object.assign([], state.query);
        for (var i = 0; i < listi.length; i++) {
          if (listi[i] === "sensitivedisclosure") {
            listi.splice(i, 1);
          }
        }
        // var PATTERN ='low' ,
        ...
        return {
          ...
          query: listi,
          exposurecategory: {
            ...state.exposurecategory,
            sensitiveinformation: {
              ...state.exposurecategory.sensitiveinformation,
              control: {
                ...state.exposurecategory.sensitiveinformation.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...state,
          query: [...state.query, "sensitivedisclosure"],
          exposurecategory: {
            ...state.exposurecategory,
            sensitiveinformation: {
              ...state.exposurecategory.sensitiveinformation,
        ...
        return {
          ...
          exposurecategory: {
            ...
            sensitiveinformation: {
              ...state.exposurecategory.sensitiveinformation,
              value: {
                ...state.exposurecategory.sensitiveinformation.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
      ...
      if (action.payload === true) {
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            discussion: {
              ...state.exposurecategory.discussion,
              control: {
                ...state.exposurecategory.discussion.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...
          exposurecategory: {
            ...
            discussion: {
              ...state.exposurecategory.discussion,
              value: {
                ...state.exposurecategory.discussion.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
      ...
      if (action.payload === true) {
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            blackmarket: {
              ...state.exposurecategory.blackmarket,
              control: {
                ...state.exposurecategory.blackmarket.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...state,
          query: [...state.query, "blackmarkets"],
          exposurecategory: {
            ...state.exposurecategory,
            blackmarket: {
              ...state.exposurecategory.blackmarket,
        ...
        return {
          ...
          exposurecategory: {
            ...
            blackmarket: {
              ...state.exposurecategory.blackmarket,
              value: {
                ...state.exposurecategory.blackmarket.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
      ...
      if (action.payload === true) {
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            financial: {
              ...state.exposurecategory.financial,
              control: {
                ...state.exposurecategory.financial.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...
          exposurecategory: {
            ...
            financial: {
              ...state.exposurecategory.financial,
              value: {
                ...state.exposurecategory.financial.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
      ...
      if (action.payload === true) {
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            exposedcredentials: {
              ...state.exposurecategory.exposedcredentials,
              control: {
                ...state.exposurecategory.exposedcredentials.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...state,
          query: [...state.query, "exposedcredentials"],
          exposurecategory: {
            ...state.exposurecategory,
            exposedcredentials: {
              ...state.exposurecategory.exposedcredentials,
        ...
        return {
          ...
          exposurecategory: {
            ...
            exposedcredentials: {
              ...state.exposurecategory.exposedcredentials,
              value: {
                ...state.exposurecategory.exposedcredentials.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
    ...
    case "personalinformation":
      if (action.payload === true) {
        const listi = Object.assign([], state.query);
        for (var i = 0; i < listi.length; i++) {
          if (listi[i] === "personalinformation") {
            listi.splice(i, 1);
          }
        }
        // var PATTERN ='low' ,
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            personalinformation: {
              ...state.exposurecategory.personalinformation,
              control: {
                ...state.exposurecategory.personalinformation.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...state,
          query: [...state.query, "personalinformation"],
          exposurecategory: {
            ...state.exposurecategory,
            personalinformation: {
              ...state.exposurecategory.personalinformation,
        ...
        return {
          ...
          exposurecategory: {
            ...
            personalinformation: {
              ...state.exposurecategory.personalinformation,
              value: {
                ...state.exposurecategory.personalinformation.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
    ...
    case "hackergrouptargeting":
      if (action.payload === true) {
        const listi = Object.assign([], state.query);
        for (var i = 0; i < listi.length; i++) {
          if (listi[i] === "hackergrouptargeting") {
            listi.splice(i, 1);
          }
        }
        // var PATTERN ='low' ,
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            hackergrouptargeting: {
              ...state.exposurecategory.hackergrouptargeting,
              control: {
                ...state.exposurecategory.hackergrouptargeting.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...state,
          query: [...state.query, "hackergrouptargeting"],
          exposurecategory: {
            ...state.exposurecategory,
            hackergrouptargeting: {
              ...state.exposurecategory.hackergrouptargeting,
        ...
        return {
          ...
          exposurecategory: {
            ...
            hackergrouptargeting: {
              ...state.exposurecategory.hackergrouptargeting,
              value: {
                ...state.exposurecategory.hackergrouptargeting.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
    ...
    case "attacksandcompromises":
      if (action.payload === true) {
        const listi = Object.assign([], state.query);
        for (var i = 0; i < listi.length; i++) {
          if (listi[i] === "attacksandcompromises") {
            listi.splice(i, 1);
          }
        }
        // var PATTERN ='low' ,
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            attacksandcompromises: {
              ...state.exposurecategory.attacksandcompromises,
              control: {
                ...state.exposurecategory.attacksandcompromises.control,
                all: !action.payload,
              },
            },
          },
        ...
        return {
          ...state,
          query: [...state.query, "attacksandcompromises"],
          exposurecategory: {
            ...state.exposurecategory,
            attacksandcompromises: {
              ...state.exposurecategory.attacksandcompromises,
        ...
        return {
          ...
          exposurecategory: {
            ...
            attacksandcompromises: {
              ...state.exposurecategory.attacksandcompromises,
              value: {
                ...state.exposurecategory.attacksandcompromises.value,
                [action.payload.value2]: !action.payload.value1,
              },
            },
          },
      ...
      if (action.payload === true) {
        ...
        return {
          ...
          exposurecategory: {
            ...state.exposurecategory,
            underanalysis: {
              ...state.exposurecategory.underanalysis,
              control: {
                ...state.exposurecategory.underanalysis.control,
                all: !action.payload,
              },
            },
          },
