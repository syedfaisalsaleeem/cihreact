...
export default function FContent(){
    ...
    const { totalFinancialInfo } = totalAllAlertsData;
        ...
        <Grid container>
            <Grid item xs={6}>
                <Grid container spacing={2}>
                    ...
                    <Grid item>
                    <LightTooltip title="Stolen or leaked credit cards and details related to payments, invoices or banking details. ">
                    <InfoOutlinedIcon />
                    </LightTooltip >
                    </Grid>
                </Grid>
                    ...
                    <Grid item xs={12} md={12} lg={12}>
                        <Grid container spacing={2} >
                            ...
                            <Card className={classes.f5}>
                                ...
                                title={<div style={{display:"flex"}}><Typography>Financial Trend </Typography>
                                    ...
                                    <Grid container direction="column" style={{height:"447px"}}spacing={3} justify="space-evenly" alignItems="center">
                                        <Grid item>
                                            <Grid container direction="column" alignItems="center">
                                                ...
                                                {totalFinancialInfo.totalAlerts}
                                                </Grid>
                                        ...
                                        <Grid item>
                                            <Grid container direction="column" alignItems="center">
                                                <Grid item style={{color:"#464E5F",fontWeight:"bold",fontSize:"40px"}}>
                                                {totalFinancialInfo.alertsToday}
                                                </Grid>
                                                <Grid item style={{color:"#B5B5C3",fontWeight:"500",fontSize:"12px;"}}>
                                                    Alert Found Today
                                                </Grid>
                                        ...
                                        <Grid item>
                                            <Grid container direction="column" alignItems="center">
                                                <Grid item style={{color:"#464E5F",fontWeight:"bold",fontSize:"40px"}}>
                                                {totalFinancialInfo.alertsLastMonth}
                                                </Grid>
                                                <Grid item style={{color:"#B5B5C3",fontWeight:"500",fontSize:"12px;"}}>
                                        ...
                                        <Grid item>
                                            <Grid container direction="column" alignItems="center">
                                                <Grid item style={{color:"#464E5F",fontWeight:"bold",fontSize:"40px"}}>
                                                {totalFinancialInfo.alertsLast3Months}
                                                </Grid>
                                                <Grid item style={{color:"#B5B5C3",fontWeight:"500",fontSize:"12px;"}}>
