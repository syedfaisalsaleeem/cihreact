        ...
        <Grid container>
            <Grid item xs={6}>
                <Grid container spacing={2}>
                    ...
                    <Grid item>
                    <LightTooltip title="Remediate your alerts here. Alerts are grouped by a remediation action for your convenience. Prioritize your remediation efforts based on the ‘Time to Exploit’. Our remediation advice - provided for each of the vulnerabilities - helps you remediate your exposure and mitigate your cyber security risk. Mark alerts as remediated when you finish remediation work to keep the page up-to-date. Note that remediated alerts will not be removed from the ‘Alerts’ pages.">
                    <InfoOutlinedIcon />
                    </LightTooltip >
                    </Grid>
                </Grid>
                    ...
                    <Grid item xs={12} md={12} lg={12}>
                        <Grid container spacing={2} >
                            ...
                            <Card className={classes.f5}>
                                ...
                                title={<div style={{display:"flex"}}><Typography>Remediation trends </Typography>
                                <Grid item style={{marginLeft:"10px"}}>
                                <LightTooltip title="This bar chart depicts the residual and remediated risks levels for each month.">
...
<InfoOutlinedIcon />
                            ...
                            <Card className={classes.f5}>
                                ...
                                title={<div style={{display:"flex"}}><Typography>Remediation progress</Typography>
                                <Grid item style={{marginLeft:"10px"}}>
                                <LightTooltip title="This pie chart depicts the percentage of remediated risk and residual risks.">
