      ...
      case 'language':
        ...
        case 'remediation':
            ...
            return {
                ...state,
                exposurecategory:{...state.exposurecategory,
                    remediation:{...state.exposurecategory.remediation,
                        control:{...state.exposurecategory.remediation.control,all:!action.payload}
...
export default function Dropup1(props){
                                            ...
                                            <Grid item xs={11}>
                                                ...
                                                <Grid item style={{display:state.source.databreach?"flex":"none"}}>
                                                    ...
                                                    <Grid item style={{display:state.exposurecategory.blackmarket.control.all?"flex":"none"}}>
                                                        ...
                                                        <Grid item style={{display:state.exposurecategory.remediation.control.all?"flex":"none"}}>

                                                        <Chip  size="small" className={classes.chip} style={{background:state.exposurecategory.remediation.control.all?"#B7E9F7":'white'}} label="remediation" variant="outlined" onClick={() => dispatch({type: 'remediation',payload:state.exposurecategory.remediation.control.all})} /> 
