...
export default function UAContent(){
    ...
    const { totalUAInfo } = totalAllAlertsData;
                    ...
                    <Grid item xs={12} md={12} lg={12}>
                        <Grid container spacing={2} >
                            ...
                            <Card className={classes.f5}>
                                ...
                                title={<div style={{display:"flex"}}><Typography>Under Analysis Trend </Typography>
